                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" value="0" id="txtPrice" name="txtPrice" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="txtStock" class="form-label">Cantidad <span class="text-danger">*</span></label>
                                <input type="number" value="0" class="form-control" id="txtStock" name="txtStock" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
