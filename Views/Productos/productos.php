...
<div class="row">
    ...
    <div class="col-md-8">
        <app-input label="Buscar"  type="text" v-model="common.strSearch" @keyup="subcategory.modalType='';category.modalType='';common.modalType='products';ingredients.modalType='';search();"></app-input>
    </div>
</div>
