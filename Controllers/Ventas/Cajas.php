    ...
    class Cajas extends Controllers{
        ...
        public function cajas(){
            if($_SESSION['permitsModule']['r']){
                ...
                $data['panelapp'] = "/Ventas/functions_cajas.js";
        ...
        public function getBuscar(){
            if($_SESSION['permitsModule']['r']){
                ...
                if($strType =="sucursales"){
                    $request = HelperPagination::getSucursales($intPage,$intPerPage,$strSearch);
                }else{
        ...
        public function getDatosIniciales(){
            if($_SESSION['permitsModule']['r']){
                $arrResponse = array(
                    "metodos"=>HelperGeneral::getMetodosPago(),
                );
