    ...
    class Bancos extends Controllers{
        ...
        public function bancos(){
            if($_SESSION['permitsModule']['r']){
                ...
                $data['panelapp'] = "/Tesoreria/functions_bancos.js";
        ...
        public function getBuscar(){
            if($_SESSION['permitsModule']['r']){
                ...
                }else if($strType =="terceros"){
                    $request = HelperPagination::getTerceros($intPage,$intPerPage,$strSearch,["is_other"=>1]);
                }else{
        ...
        public function setDatos(){
            if($_SESSION['permitsModule']['r']){
                ...
                if(!empty($data)){
                    $campos = [ "tercero"=>$data['tercero'], "tipo"=>$data['tipo'], "cuenta_banco"=>$data['cuenta_banco'],"cuenta"=>$data['cuenta']];
                    $validar = [ "tercero"=>"required", "tipo"=>"required", "cuenta_banco"=>"required;cuenta bancaria","cuenta"=>"required;cuenta contable"];
                    ...
                    if(!empty($errores)){
                        ...
                        if(is_numeric($request) && $request > 0){
                            ...
                            $arrResponse = array('status' => false, 'msg' => 'La cuenta bancaria ya existe, pruebe cambiando el tercero, cuenta bancaria o tipo.');		
                        }else{
