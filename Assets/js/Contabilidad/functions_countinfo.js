...
btnContabilidadMes.addEventListener("click",function(){
    ...
    request(base_url+"/Contabilidad/Contabilidad/getContabilidadMes",formData,"post").then(function(objData){
        ...
        document.querySelector("#tableDetail").innerHTML = objData.detail;
        document.querySelector("#titleDetail").innerHTML = "Detalle mensual"+objData.dataingresos.month+" "+objData.dataingresos.year;
    });
});
btnContabilidadAnio.addEventListener("click",function(){
    ...
    request(base_url+"/Contabilidad/Contabilidad/getContabilidadAnio",formData,"post").then(function(objData){
        ...
        if(objData.status){
            ...
            document.querySelector("#tableDetailAnual").innerHTML = objData.info;
            document.querySelector("#titleDetailAnual").innerHTML = "Detalle anual "+objData.year;
        }else{
